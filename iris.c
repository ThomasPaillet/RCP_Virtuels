...
extern GtkCssProvider *css_provider_white, *css_provider_raz;
...
GtkWidget *create_iris_frame (rcp_t *rcp)
{
	...
	gtk_widget_set_margin_end (box1, MARGIN_VALUE);
		box3 = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 0);
			...
			gtk_style_context_add_provider (gtk_widget_get_style_context (widget), GTK_STYLE_PROVIDER (css_provider_white), GTK_STYLE_PROVIDER_PRIORITY_APPLICATION + 1);
